...
msg0 db "Simple Arithmetic calculator using assembly code",0Dh,0Ah,'$' 

msg1 db "Enter the operator:Addition(+) ,Subtraction(-),Multiplication(*),Division (/): $"
msg2 db 0Dh,0Ah, 0Dh,0Ah, 'Enter the first number: $'

msg3 db "Enter the second number: $"
msg4 db  0dh,0ah , 'Result for the given operation : $' 
